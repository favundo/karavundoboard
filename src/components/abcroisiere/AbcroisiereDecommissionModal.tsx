...
const AbcroisiereDecommissionModal = ({ open, onClose }: Props) => {
        ...
        {step === "input" ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>Saisissez le numéro d'asset de l'équipement à retirer de l'inventaire.</DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>Êtes-vous sûr de vouloir décommissionner cet équipement ? Cette action est irréversible.</DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button variant="destructive" onClick={() => deleteMutation.mutate(asset.trim())} disabled={deleteMutation.isPending}>
                <Trash2 size={14} />{deleteMutation.isPending ? "Suppression…" : "Confirmer la suppression"}
              </Button>
            </DialogFooter>
          </>
        )}
...
export default AbcroisiereDecommissionModal;
