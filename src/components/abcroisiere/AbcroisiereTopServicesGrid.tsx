...
const AbcroisiereTopServicesGrid = () => {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5">
      <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Top services</h3>
          ...
          <div key={name} className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="h-1.5 w-full rounded-full bg-muted">
                <div className="h-full rounded-full bg-gradient-to-r from-primary to-accent transition-all duration-500" style={{ width: `${(count / maxVal) * 100}%` }} />
              </div>
            </div>
          </div>
        ))}
...
export default AbcroisiereTopServicesGrid;
