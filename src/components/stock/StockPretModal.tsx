...
const StockPretModal = ({ open, onClose }: Props) => {
  ...
  const handleSearch = async () => {
    ...
    if (result) {
      setFoundInfo(result.nom ? `Affecté à ${result.nom}` : "Disponible");
      setStep("utilisateur");
    } else {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {step === "utilisateur" && (
          <>
            ...
            <DialogFooter>
              ...
              <Button onClick={() => setStep("confirm")} disabled={!utilisateur.trim()}>Suivant</Button>
            </DialogFooter>
          </>
        )}
        ...
        {step === "confirm" && (
          <>
            ...
            <DialogFooter>
              <Button variant="outline" onClick={() => setStep("utilisateur")}>Retour</Button>
              <Button
                onClick={() => pretMutation.mutate({ assetCode: asset, user: utilisateur })}
