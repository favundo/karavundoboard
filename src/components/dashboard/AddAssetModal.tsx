...
const AddAssetModal = ({ open, onClose }: Props) => {
        ...
        {step === "input" ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Saisissez le numéro d'asset de l'équipement à ajouter.
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={!assetInput.trim() || checkMutation.isPending}
              >
                <Search size={14} />
                Continuer
              </Button>
          ...
          <>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <Label htmlFor="dns">
                    NOM DNS <span className="text-destructive">*</span>
                  </Label>
                  <Input
                    id="dns"
                    placeholder="ex: PC-DUPONT"
                    value={form.dns}
                    onChange={(e) => handleField("dns", e.target.value)}
                  />
                </div>
                <div className="space-y-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleField("matricule", e.target.value)}
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      placeholder="Pseudo"
                      value={form.pseudo}
                      onChange={(e) => handleField("pseudo", e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      placeholder="UID"
                      value={form.uid}
                      onChange={(e) => handleField("uid", e.target.value)}
                    />
                  </div>
                  <div className="flex items-center gap-2 pt-5">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleField("absence", !!checked)}
                    />
            ...
            <DialogFooter>
              ...
              >
                <PlusCircle size={14} />
                {insertMutation.isPending ? "Ajout en cours…" : "Ajouter l'asset"}
              </Button>
            </DialogFooter>
          </>
        )}
