      ...
      <div className="relative z-10 w-full max-w-4xl rounded-2xl border border-border bg-card shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-foreground">Mettre à jour l'inventaire</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-border bg-muted/20 p-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {["Nom", "Service", "Asset", "Type", "SN", "DNS", "UID", "Matricule", "Absence", "Remarques", "App. ESET"].map((col) => (
                    ...
                    <tbody>
                      {parseResult.items.slice(0, 8).map((item, i) => (
                        <tr key={i} className="border-b border-border/50 hover:bg-muted/20">
                          ...
                          <td className="max-w-[160px] truncate px-3 py-2 font-mono text-[10px] text-muted-foreground">
                            {item.dns || "—"}
                          </td>
                        </tr>
                      ))}
