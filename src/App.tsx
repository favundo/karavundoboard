...
import SupportTelephonie from "./components/support/SupportTelephonie";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/groupes-province" element={<Province />} />
          ...
          <Route path="/support" element={<Support />}>
            ...
            <Route path="telephonie" element={<SupportTelephonie />} />
