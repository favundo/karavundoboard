import { HeadsetIcon, LayoutDashboard, CalendarDays, ClipboardList, UserPlus, BarChart3, ShieldCheck, PhoneCall } from 'lucide-react';
...
const SUB_NAV = [
  ...
  { to: '/support/telephonie',   label: 'Téléphonie',                             icon: PhoneCall      },
];
